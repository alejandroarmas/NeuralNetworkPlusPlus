#ifndef TEMPLATED_MATRIX_BENCHMARKER_IMPLEMENTATION
#define TEMPLATED_MATRIX_BENCHMARKER_IMPLEMENTATION
...
namespace Matrix {
    ...
    std::unique_ptr<Representation> Timer<MatrixOperation>::operator()(std::unique_ptr<Matrix::Representation>& l, 
...
// #ifdef CILKSCALE
    ...
    */
    template <class MatrixOperation>
    std::unique_ptr<Representation> ParallelMeasurer<MatrixOperation>::operator()(std::unique_ptr<Matrix::Representation>& l, 
            std::unique_ptr<Matrix::Representation>& r) {
...
#endif // TEMPLATED_MATRIX_BENCHMARKER_IMPLEMENTATION