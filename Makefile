...
MAIN = main.o
OBJS = main.o matrix.o generator.o matrix_printer.o functions.o network_layer.o m_algorithms.o m_algorithms_register.o matrix_benchmark.o activation_functions.o tensor.o 
